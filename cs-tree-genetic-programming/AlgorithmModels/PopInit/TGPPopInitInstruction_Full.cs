...
namespace TreeGP.AlgorithmModels.PopInit
{
    ...
    /// <summary>
    /// Population Initialization method following the "Full" method described in Algorithm 2.1 of "A Field Guide to Genetic Programming"
    /// </summary>
    ...
    public class TGPPopInitInstruction_Full<P, S> : PopInitInstruction<P, S>
        where S : IGPSolution
        where P : IGPPop
    {
        public TGPPopInitInstruction_Full()
        {

        }

        public TGPPopInitInstruction_Full(XmlElement xml_level1)
            : base(xml_level1)
        {
        ...
        {
            TGPPopInitInstruction_Full<P, S> clone = new TGPPopInitInstruction_Full<P, S>();
            return clone;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append(">> Name: TGPPopInitInstruction_Full\n");
            return sb.ToString();
        }
    }
}

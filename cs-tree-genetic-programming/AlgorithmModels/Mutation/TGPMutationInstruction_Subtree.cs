...
namespace TreeGP.AlgorithmModels.Mutation
{
    ...
    public class TGPMutationInstruction_Subtree<P, S> : MutationInstruction<P, S>
        where S : IGPSolution
        where P: IGPPop
    {
        public TGPMutationInstruction_Subtree()
        {
            
        }

        public TGPMutationInstruction_Subtree(XmlElement xml_level1)
            : base(xml_level1)
        {
        ...
        public override void Mutate(P pop, S child)
        {
            ...
            child.Mutate(iMaxProgramDepth, TGPProgram.MUTATION_SUBTREE);
        }

        public override MutationInstruction<P, S> Clone()
        {
            TGPMutationInstruction_Subtree<P, S> clone = new TGPMutationInstruction_Subtree<P, S>();
            return clone;
        }
    }
}
